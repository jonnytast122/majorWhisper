...
class _LearningResultState extends State<LearningResult> {
  ...
  // Method to save the learning path data to Firestore
  Future<void> saveToFirestore() async {
    try {
      ...
      if (userId != null) {
        ...
        // Append new learning path to the existing data array
        await userDoc.update({
          'data': FieldValue.arrayUnion([{
            'major_name': widget.majorName,
            'degree': widget.degree,
            'learning_path': widget.data,
          }])
  ...
  Widget build(BuildContext context) {
    ...
    final learningPath = widget.data[widget.degree.toLowerCase() + '_degree_learning_path'] ??
