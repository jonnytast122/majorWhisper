...
class _QuizhistoryState extends State<Quizhistory> {
  ...
  Widget build(BuildContext context) {
    ...
    final recommendedMajors = widget.quizData['recommended_major'] as List<dynamic>?;
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20.0),
            if (recommendedMajors != null) // Add button if recommended majors exist
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => RecommendedMajorHistory(
